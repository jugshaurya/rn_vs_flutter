...
| **Average FPS**                                |              |                            |         |                       |
| **Lowest FPS**                                 |              |                            |         |                       |
| **Average CPU usage <br/> (all threads)**      |              |                            |         |                       |
| **Highest CPU Usage <br/> (all threads)**      |              |                            |         |                       |
| **Highest CPU Usage <br/> for UI(/JS) Thread** |              |                            |         |                       |
| **Average RAM Usage**                          |              |                            |         |                       |
| **Highest RAM Usage**                          |              |                            |         |                       |
...
| Metric                                         | Flutter IDLE    | Flutter with Interactivity | RN IDLE                                         | RN with Interactivity                           |
| ---------------------------------------------- | :-------------- | :------------------------- | ----------------------------------------------- | ----------------------------------------------- |
| **Overall Score**                              | 96              | 85                         | 87                                              | 74                                              |
| **Average FPS**                                | 55.1            | 43.1                       | 51.6                                            | 45.6                                            |
| **Lowest FPS**                                 | 22              | 24                         | 40                                              | 30                                              |
| **Average CPU usage <br/> (all threads)**      | 14%             | 55.5%                      | 28.4%                                           | 78.9%                                           |
| **Highest CPU Usage <br/> (all threads)**      | 101.1%          | 104.1%                     | 136.9%                                          | 204.3%                                          |
| **Highest CPU Usage <br/> for UI(/JS) Thread** | 63% (UI Thread) | 60.1% (UI Thread)          | 33.3% (for UI Thread) <br/> 98% (for JS Thread) | 61% (for UI Thread) <br/> 99.6% (for JS Thread) |
| **Average RAM Usage**                          | 274.7MB         | 264.2MB                    | 210.8MB                                         | 287.1MB                                         |
| **Highest RAM Usage**                          | 275 MB          | 292MB                      | 253MB                                           | 311                                             |
